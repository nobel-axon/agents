...
// ApproveBounty transitions a bounty from Pending to Active.
func (t *BountyArenaTransactor) ApproveBounty(opts *bind.TransactOpts, bountyId *big.Int) (*types.Transaction, error) {
	return t.contract.Transact(opts, "approveBounty", bountyId)
}

// RejectBounty rejects a pending bounty and refunds the creator.
func (t *BountyArenaTransactor) RejectBounty(opts *bind.TransactOpts, bountyId *big.Int, reason string) (*types.Transaction, error) {
	return t.contract.Transact(opts, "rejectBounty", bountyId, reason)
}
